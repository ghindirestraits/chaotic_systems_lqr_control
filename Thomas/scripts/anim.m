...
figh1 = figure('Name','Thomas System: Drive-Response Visualization', ...
    'NumberTitle','off', 'Position', [0 0 960 1080]);
grid on
h1 = animatedline('MaximumNumPoints', 5000, 'Color', 'r', 'LineWidth', 1);
h2 = animatedline('MaximumNumPoints', 5000, 'Color', 'b', 'LineWidth', 1);
